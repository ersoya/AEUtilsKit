...
public extension CGFloat {
    ...
    static let twoHundredNinety: CGFloat = 290.0
    static let threeHundredTwentySix: CGFloat = 326.0
    static let fourHundredFifty: CGFloat = 450.0
    static let fiveHundred: CGFloat = 500.0
    static let sevenHundredFifty: CGFloat = 750.0
}
